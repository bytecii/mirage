 ...
 * `packages/node/src/vfs/s3_alias.ts`; it carries credentials and a
 ...
 * own pair, so the VFS layer takes the two functions every provider
 * has either way. Mirrors python `S3AliasVFS` in
