...
| MinIO | read, write | [MinIO](/home/setup/minio) | [<Icon icon="python" />](/python/resource/minio) | Self-hosted S3-compatible store |
| Ceph | read, write | [Ceph](/home/setup/ceph) | [<Icon icon="python" />](/python/resource/ceph) | Ceph Rados Gateway (self-hosted) |
| Wasabi | read, write | [Wasabi](/home/setup/wasabi) | [<Icon icon="python" />](/python/resource/wasabi) | Low-cost S3-compatible cloud |
| Backblaze B2 | read, write | [Backblaze B2](/home/setup/backblaze) | [<Icon icon="python" />](/python/resource/backblaze) | B2 via S3 API |
| DigitalOcean Spaces | read, write | [DigitalOcean](/home/setup/digitalocean) | [<Icon icon="python" />](/python/resource/digitalocean) | DO Spaces via S3 API |
| Tencent COS | read, write | [Tencent COS](/home/setup/tencent) | [<Icon icon="python" />](/python/resource/tencent) | Tencent Cloud Object Storage |
| Alibaba OSS | read, write | [Alibaba OSS](/home/setup/aliyun) | [<Icon icon="python" />](/python/resource/aliyun) | Aliyun Object Storage Service |
| Scaleway | read, write | [Scaleway](/home/setup/scaleway) | [<Icon icon="python" />](/python/resource/scaleway) | Scaleway Object Storage |
| QingStor | read, write | [QingStor](/home/setup/qingstor) | [<Icon icon="python" />](/python/resource/qingstor) | QingCloud Object Storage |
| HF Buckets | read, write | [HF Buckets](/home/setup/hf_buckets) | [<Icon icon="python" />](/python/resource/hf_buckets) | Hugging Face Buckets |
| HF Datasets | read, write | [HF Datasets](/home/setup/hf_datasets) | [<Icon icon="python" />](/python/resource/hf_datasets) | Hugging Face Dataset repos (lazy reads) |
| HF Models | read, write | [HF Models](/home/setup/hf_models) | [<Icon icon="python" />](/python/resource/hf_models) | Hugging Face Model repos (weights stream on demand) |
| HF Spaces | read, write | [HF Spaces](/home/setup/hf_spaces) | [<Icon icon="python" />](/python/resource/hf_spaces) | Hugging Face Space repos (app code, configs) |
