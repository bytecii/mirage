...
directory contains `database.json` with schema metadata and row objects.
Each page directory contains a `page.json` file with the page metadata and
content. Child pages appear as nested directories.
