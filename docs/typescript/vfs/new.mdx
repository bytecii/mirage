...
- A search push-down built with `makeSearch` answers only what it can answer exactly as grep over the files would; anything else falls back to the generic scan.
